            ...
            <nav class="navbar navbar-expand-lg ">
                <div class="container-fluid">
                    ...
                    <a class="navbar-brand" href="#">
                        <img src="{{ Vite::asset('resources/images/logo telu.png') }}" alt="Bootstrap" width="155" height="48"
                    ...
                    <div class="collapse navbar-collapse d-flex" id="navbarSupportedContent">
                        <ul class="navbar-nav me-auto mb-2 mb-lg-0 ">
                            ...
                            <li class="nav-item dropdown"  style="margin-right: 1em;">
                                <a class="nav-link dropdown-toggle" href="#" role="button" data-bs-toggle="dropdown"
                                    aria-expanded="false" style="padding: 33px 7px; color:black;">
                                    <img src="{{ Vite::asset('resources/images/indonesia.png') }}" alt="Bootstrap" width="22" height="18">

                                </a>

                            </li class="nav-item"  style="margin-right: 1em;">
                            <a class="nav-link" href="#" style="padding: 33px 7px; color:black;">
                                <img src="{{ Vite::asset('resources/images/search.png') }}" alt="Bootstrap" width="24" height="24">
                            </a>
                ...
                <div class=" mb-5" style="margin-top:5em;">
                    ...
                    <p>
                      <a href="#!" class="text-reset" >
                        <img src="{{ Vite::asset('resources/images/kampus.webp') }}"  width="229" height="61" style=" margin-top:1em;">
                      </a>
                    </p>
                    <p>
                        <div class="d-flex" >
                            <div style="margin-right: 10px;">
                                <img src="{{ Vite::asset('resources/images/loc.png') }}" alt="" width="18px">
                            </div>
                    ...
                    <p>
                        <div class=" " >
                            <a class=" "> 
                                <img src="{{ Vite::asset('resources/images/mdi--instagram.svg') }}" alt="" width="22px" style="margin-left:20px;">
                                <img src="{{ Vite::asset('resources/images/mdi--youtube.svg') }}" alt="" width="22px"  style="margin-left:15px;">
                                <img src="{{ Vite::asset('resources/images/ri--linkedin-fill.svg') }}" alt="" width="22px"  style="margin-left:15px;">
                                <img src="{{ Vite::asset('resources/images/ic--baseline-facebook.svg') }}" alt="" width="22px"  style="margin-left:15px;">
                                <img src="{{ Vite::asset('resources/images/ic--baseline-tiktok.svg') }}" alt="" width="22px" style="margin-left:15px;">
                                <img src="{{ Vite::asset('resources/images/ri-twitter-x-fill.svg') }}" alt="" width="22px"  style="margin-left:15px;">
                            </a>
                        </div>
                      </a>
                    </p>
